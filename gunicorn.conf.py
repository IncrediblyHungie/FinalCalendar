...
# Worker Processes - Memory-optimized for 4GB RAM
# Each worker uses ~320MB RAM. 6 workers = ~1.9GB, leaves 2GB for OS/buffers/spikes
workers = 6  # Upgraded for 4GB RAM (supports ~24 concurrent requests)
...
def on_starting(server):
    ...
    server.log.info(f"   RAM: 4GB (upgraded from 2GB)")
